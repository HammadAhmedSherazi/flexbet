                              ...
                              Container(
                                ...
                                decoration: BoxDecoration(
                                    ...
                                    gradient: LinearGradient(
                                      colors: categoriesNewList[index]['gradiant'],
                                      stops: const [0, 1],
                    ...
                    children: [
                        ...
                        child: Container(
                          ...
                          child: Obx(() {
                            return (controller.groupBannerImage.value != null)
                                ? FadeInImage(
                                  image: FileImage(
                                      controller.groupBannerImage.value!),
                      ...
                      Expanded(
                          child: Column(
                            children: [
                              const Text(
                                "1 photo with a total size upto 2M",
                              ),
                              const SizedBox(
                                height: 5.0,
                              ),
                          ...
                          child: GestureDetector(
                            ...
                            child: Center(
                                child: Column(
                                  ...
                                  children: [
                                    Image.asset(ImageConstant.iconPng,height: 50.0,width: 50.0,),
                                    RichText(
                                        text: TextSpan(
                                    ...
                                    Text("Support, JPG,JPEG,PNG",style: FlexxBetStyles.textStyle.copyWith(fontSize: 14,color: ColorConstant.gray500),)
                                  ],
                                )
                            ),
                          ),
                        ...
                        controller.groupCreationEligibility(controller: walletController)
                          ...
                          if (value == false) {
                            showAlertDialog(
                                ...
                                infoText:
                                    "You've not enough balance in your wallet. N1000 balance is required to create a group. please fund your wallet & continue",
